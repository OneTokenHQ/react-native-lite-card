package so.onetoken.app.wallet.lite.onetokenLite
...
import so.onetoken.app.wallet.lite.onetokenLite.nfc.AppleCardType
import so.onetoken.app.wallet.lite.onetokenLite.nfc.Connection
import so.onetoken.app.wallet.lite.onetokenLite.nfc.CommandGenerator
import so.onetoken.app.wallet.lite.utils.LogUtil.printLog
import so.onetoken.app.wallet.lite.utils.NfcPermissionUtils

object OneTokenLiteCard {
    const val TAG = "OneTokenLiteCard"
