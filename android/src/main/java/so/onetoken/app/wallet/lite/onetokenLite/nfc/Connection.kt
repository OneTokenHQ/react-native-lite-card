package so.onetoken.app.wallet.lite.onetokenLite.nfc

import android.nfc.TagLostException
import android.nfc.tech.IsoDep
import org.haobtc.onetoken.card.gpchannel.GPChannelNatives
import org.haobtc.onetoken.card.gpchannel.GPChannelNatives.nativeGPCFinalize
import so.onetoken.app.wallet.lite.keys.KeysNativeProvider
import so.onetoken.app.wallet.lite.nfc.NFCExceptions
import so.onetoken.app.wallet.lite.onetokenLite.NfcConstant
import so.onetoken.app.wallet.lite.onetokenLite.entitys.*
import so.onetoken.app.wallet.lite.onetokenLite.nfc.GPCAPDUGenerator.buildGPCAPDU
import so.onetoken.app.wallet.lite.onetokenLite.nfc.GPCAPDUGenerator.combCommand
import so.onetoken.app.wallet.lite.utils.HexUtils
import so.onetoken.app.wallet.lite.utils.HexUtils.byteArr2HexStr
import so.onetoken.app.wallet.lite.utils.HexUtils.hexString2Bytes
import so.onetoken.app.wallet.lite.utils.LogUtil.printLog
